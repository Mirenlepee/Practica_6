...
public class DataSetMunicipios {
	...
	public ArrayList<Municipio> getMunicipiosEnProvincia(String provinciaSel){
		ArrayList<Municipio> municipiosEnProvincia = new ArrayList<>();
		for(Municipio municipio: lMunicipios) {
			if (municipio.getProvincia().equals(provinciaSel)) {
				municipiosEnProvincia.add(municipio);
			}
		}
